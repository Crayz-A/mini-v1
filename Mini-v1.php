...
<title>CyberEagle</title>

  <div align="center">
    <table width="887" border="1">
      <tr>
        <td height="50" colspan="3"><div align="center"><span class="style6">By CyberEagle Team</span><br />
          Create By Crayz.a<br />
          <br />
      </tr>
      <tr>
...
?>
        ...
        <td width="282" height="100" valign="top" bordercolor="Red"><form method="post" action="">
...
?>
        ...
        <td width="308" valign="top" bordercolor="Red"><form action="" method="post" name="form2" id="form2">
          <p>
            <label></label>
...
?>
      ...
      <tr>
        <td width="275" height="100" valign="top" bordercolor="Red"><form action="" method="post" name="form5" id="form5">
